...
export default function KanjivaramPage() {
  ...
  const categoryData = {
    ...
    subtitle: "Traditional South Indian Elegance",
    description: "Handwoven in Kanchipuram, Tamil Nadu, these sarees are known for their rich colors, heavy silk, and intricate zari work. Perfect for weddings and special occasions.",
    backgroundColor: "from-purple-900 to-red-900",
    heroImage: "/images/bb5.jpeg",
    designs: "120+",
    features: ["Pure Mulberry Silk", "Temple Border Designs", "Contrast Pallu", "Heavy Zari Work"]
  };
  ...
  const priceRanges = [
    ...
    { id: 'under20k', name: 'Under ₹20,000', min: 0, max: 20000 },
    { id: '20to25k', name: '₹20,000 - ₹25,000', min: 20000, max: 25000 },
    { id: 'above25k', name: 'Above ₹25,000', min: 25000, max: Infinity },
  ];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch('https://api-xmg2fjjbya-uc.a.run.app/api/sarees?category=kanjivaram');
         ...
         <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div>
                <p className="text-xl sm:text-2xl font-light mb-1">Kanjivaram</p>
                ...
                sortedProducts.map(product => (
                  <div key={product.id} className="group cursor-pointer bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition">
                    <div className="relative overflow-hidden bg-stone-100 aspect-[3/4]">
                      <img 
                        src={product.images && product.images[0] ? `https://api-xmg2fjjbya-uc.a.run.app${product.images[0]}` : '/placeholder.jpg'} 
