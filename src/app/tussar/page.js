...
export default function TussarPage() {
  ...
  const categoryData = {
    ...
    subtitle: "Natural Golden Sheen",
    description: "Known for their natural gold texture and lightweight feel, Tussar silk sarees offer understated elegance.",
    backgroundColor: "from-yellow-900 to-orange-900",
    heroImage: "/images/tussar.jpg",
    designs: "80+",
    features: ["Wild Silk", "Natural Gold Color", "Lightweight", "Tribal Motifs"]
  };
  ...
  const priceRanges = [
    ...
    { id: 'under15k', name: 'Under ₹15,000', min: 0, max: 15000 },
    { id: '15to20k', name: '₹15,000 - ₹20,000', min: 15000, max: 20000 },
    { id: 'above20k', name: 'Above ₹20,000', min: 20000, max: Infinity },
  ];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch('https://api-xmg2fjjbya-uc.a.run.app/api/sarees?category=tussar');
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div>
                <p className="text-xl sm:text-2xl font-light mb-1">Tussar</p>
