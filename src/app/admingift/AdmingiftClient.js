...
export default function AdminGiftsPage() {
  ...
  const fetchGifts = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://zyra-website.onrender.com/api/giftitems");
  ...
  const fetchCategories = async () => {
    const res = await fetch("https://zyra-website.onrender.com/api/giftcategories");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let url = "https://zyra-website.onrender.com/api/giftitems";
      let method = "POST";
      
      if (editGift) {
        url = `https://zyra-website.onrender.com/api/giftitems/${editGift.gift_item_id}`;
        method = "PUT";
      }
  ...
  const deleteGift = async (giftItemId) => {
    ...
    try {
      const response = await fetch(`https://zyra-website.onrender.com/api/giftitems/${giftItemId}`, { 
        method: "DELETE" 
      });
