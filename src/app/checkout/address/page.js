...
<button
  onClick={() => {
    ...
    console.log('showAddForm before:', showAddForm); // Add this
    setShowAddForm(!showAddForm);
    setEditingAddress(null);
    resetForm();
    console.log('showAddForm after:', !showAddForm); // Add this
  }}
...
>
  ...
  Add New Address
              ...
              {showAddForm && (
                <div className="mb-6 p-6 border-2 border-amber-200 rounded-lg bg-amber-50">
