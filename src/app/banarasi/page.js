...
export default function BanarasiPage() {
  ...
  const categoryData = {
    ...
    subtitle: "Regal Weaves from Varanasi",
    description: "Originating from Varanasi, these luxurious sarees feature intricate brocade work with gold and silver threads.",
    backgroundColor: "from-red-900 to-amber-900",
    heroImage: "/images/sfgdh (1).jpg",
    designs: "95+",
    features: ["Brocade Weaving", "Mughal Motifs", "Gold & Silver Zari", "Rich Texture"]
  };
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch('https://api-xmg2fjjbya-uc.a.run.app/api/sarees?category=banarasi');
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div>
                <p className="text-xl sm:text-2xl font-light mb-1">Banarasi</p>
