...
export default function AdminGiftCategoriesPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let url = "https://zyra-website.onrender.com/api/giftcategories";
      let method = "POST";
      
      if (editCategory) {
        url = `https://zyra-website.onrender.com/api/giftcategories/${editCategory.gift_category_id}`;
        method = "PUT";
      }
  ...
  const deleteCategory = async (categoryId) => {
    ...
    try {
      const response = await fetch(`https://zyra-website.onrender.com/api/giftcategories/${categoryId}`, { 
        method: "DELETE" 
      });
