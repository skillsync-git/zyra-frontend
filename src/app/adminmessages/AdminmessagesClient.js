...
export default function AdminMessagesPage() {
  ...
  const fetchMessages = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://zyra-website.onrender.com/api/contact-messages");
  ...
  const fetchStats = async () => {
    try {
      const res = await fetch("https://zyra-website.onrender.com/api/contact-messages/stats");
  ...
  const updateStatus = async (messageId, newStatus) => {
    try {
      const res = await fetch(`https://zyra-website.onrender.com/api/contact-messages/${messageId}/status`, {
        method: 'PUT',
  ...
  const deleteMessage = async (messageId) => {
    ...
    try {
      const res = await fetch(`https://zyra-website.onrender.com/api/contact-messages/${messageId}`, { method: 'DELETE' });
      if (res.ok) {
        await fetchMessages();
        await fetchStats();
