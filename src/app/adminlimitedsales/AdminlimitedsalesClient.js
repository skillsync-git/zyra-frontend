...
export default function AdminLimitedSalesPage() {
  ...
  const fetchLimitedSales = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://api-xmg2fjjbya-uc.a.run.app/api/admin/limited-sales");
  ...
  const fetchStats = async () => {
    try {
      const res = await fetch("https://api-xmg2fjjbya-uc.a.run.app/api/admin/sales-stats");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingId
        ? `https://api-xmg2fjjbya-uc.a.run.app/api/admin/limited-sales/${editingId}`
        : "https://api-xmg2fjjbya-uc.a.run.app/api/admin/limited-sales";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://api-xmg2fjjbya-uc.a.run.app/api/admin/limited-sales/${id}`, {
        method: "DELETE",
      });
