    ...
    const fetchProduct = async () => {
      try {
        ...
        if (data.images && data.images.length > 0) {
          setMainImage(`${API_BASE_URL}${data.images[0]}`);
        } else {
  ...
  const reviews = [
    {
      id: 1,
      rating: 5,
      comment: "Beautiful cotton saree! The fabric quality is excellent and very comfortable to wear.",
      author: "Priya S",
      date: "15 Oct 2025",
      image: "/images/ab3.jpeg"
    },
    {
      id: 2,
      rating: 4,
      comment: "Good quality saree. Worth the price!",
      author: "Anita K",
      date: "8 Oct 2025",
      image: null
    },
    {
      id: 3,
      rating: 5,
      comment: "Loved the traditional design and color combination.",
      author: "Meera R",
      date: "2 Oct 2025",
      image: null
    }
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="border-t pt-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold">10% Instant Discount on HDFC Bank Cards</span>
                  </div>
                ...
                <div className="border-t pt-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold">7.5% Cashback on Axis Bank Credit Card</span>
                  </div>
